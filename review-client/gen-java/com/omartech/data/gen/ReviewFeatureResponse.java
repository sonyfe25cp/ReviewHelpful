            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.words = new ArrayList<String>(_list28.size);
                String _elem29;
                for (int _i30 = 0; _i30 < _list28.size; ++_i30)
                {
                  _elem29 = iprot.readString();
                  struct.words.add(_elem29);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReviewFeatureResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.words != null) {
        oprot.writeFieldBegin(WORDS_FIELD_DESC);
        {
          ...
          for (String _iter31 : struct.words)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.words = new ArrayList<String>(_list33.size);
          String _elem34;
          for (int _i35 = 0; _i35 < _list33.size; ++_i35)
          {
            _elem34 = iprot.readString();
            struct.words.add(_elem34);
          }
        }
        struct.setWordsIsSet(true);
      }
