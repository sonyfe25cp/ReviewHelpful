            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.adjs = new ArrayList<String>(_list31.size);
                String _elem32;
                for (int _i33 = 0; _i33 < _list31.size; ++_i33)
                {
                  _elem32 = iprot.readString();
                  struct.adjs.add(_elem32);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReviewFeatureResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.words != null) {
        oprot.writeFieldBegin(WORDS_FIELD_DESC);
        {
          ...
          for (String _iter34 : struct.words)
          {
      ...
      if (struct.adjs != null) {
        oprot.writeFieldBegin(ADJS_FIELD_DESC);
        {
          ...
          for (String _iter35 : struct.adjs)
          {
      ...
      if (struct.isSetWords()) {
        {
          ...
          for (String _iter36 : struct.words)
          {
      ...
      if (struct.isSetAdjs()) {
        {
          ...
          for (String _iter37 : struct.adjs)
          {
